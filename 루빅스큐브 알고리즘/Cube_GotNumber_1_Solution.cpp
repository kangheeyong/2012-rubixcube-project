...
int GotNumber_1 :: rotation_1(int (*p)[9]) //보라색 위 왼쪽 1
{
...
int GotNumber_1 :: rotation_2(int (*p)[9]) //보라색 위 왼쪽 2
{
	rotation_1(p);
	rotation_1(p);
	return 2;
}
int GotNumber_1 :: rotation_3(int (*p)[9]) //보라색 위 오른쪽 1
{
	rotation_1(p);
	rotation_1(p);
	rotation_1(p);
...
int GotNumber_1 :: rotation_4(int (*p)[9])
{
...
int GotNumber_1 :: rotation_5(int (*p)[9])
{
	rotation_4(p);
	rotation_4(p);
	return 5;
}
int GotNumber_1 :: rotation_6(int (*p)[9])
{
	rotation_4(p);
	rotation_4(p);
	rotation_4(p);
...
int GotNumber_1 :: rotation_7(int (*p)[9])
{
...
int GotNumber_1 :: rotation_8(int (*p)[9])
{
	rotation_7(p);
	rotation_7(p);
	return 8;
}
int GotNumber_1 :: rotation_9(int (*p)[9])
{
	rotation_7(p);
	rotation_7(p);
	rotation_7(p);
...
int GotNumber_1 :: rotation_10(int (*p)[9])
{
...
int GotNumber_1 :: rotation_11(int (*p)[9])
{
	rotation_10(p);
	rotation_10(p);
	return 11;
}
int GotNumber_1 :: rotation_12(int (*p)[9])
{
	rotation_10(p);
	rotation_10(p);
	rotation_10(p);
...
int GotNumber_1 :: rotation_13(int (*p)[9])
{
...
int GotNumber_1 :: rotation_14(int (*p)[9])
{
	rotation_13(p);
	rotation_13(p);
	return 14;
}
int GotNumber_1 :: rotation_15(int (*p)[9])
{
	rotation_13(p);
	rotation_13(p);
	rotation_13(p);
...
int GotNumber_1 :: rotation_16(int (*p)[9])
{
...
int GotNumber_1 :: rotation_17(int (*p)[9])
{
	rotation_16(p);
	rotation_16(p);
	return 17;
}
int GotNumber_1 :: rotation_18(int (*p)[9])
{
	rotation_16(p);
	rotation_16(p);
	rotation_16(p);
...
int GotNumber_1 :: rotation_19(int (*p)[9])
{
...
int GotNumber_1 :: rotation_20(int (*p)[9])
{
